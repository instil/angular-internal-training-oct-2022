...
import {HangmanRefactoringReduxExercise} from "./refactoring-hangman-redux/HangmanRefactoringExercise";
...
export const routes = [
    ...
    {path: '/async-await-convert-promises', component: AsyncAwaitPromisesExercise, title: "Async Await from Promises"},
    ...
    {path: '/refactoring-hangman-redux', component: HangmanRefactoringReduxExercise, title: "Hangman Refactoring (Redux)"},
];
