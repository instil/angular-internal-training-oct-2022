import {calculatePokerHand} from "./Solution";

describe('Poker Hand', () => {
    [
        {hand: 'AH 2H 3H 4H 6S', expectedName: 'High Card', testName: 'Basic High Card'},
        {hand: 'KH QH JH 10H 8S', expectedName: 'High Card', testName: 'Basic High Card - Reverse order'},
        ...
        {hand: '8D 10D JD QD KD', expectedName: 'Flush', testName: 'Flush Diamonds'},
        ...
        {hand: '10D JD QD KD AH', expectedName: 'Straight', testName: 'Ace High Straight'},
        {hand: '5H 5C 5D 3D 5S', expectedName: 'Four of a Kind', testName: 'Four of a Kind'},
        {hand: '10D JD QD KD 9D', expectedName: 'Straight Flush', testName: 'Straight Flush'},
        {hand: '10D JD QD KD AD', expectedName: 'Royal Flush', testName: 'Royal Flush'},
